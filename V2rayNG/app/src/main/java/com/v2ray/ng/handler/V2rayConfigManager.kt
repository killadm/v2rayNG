...
import com.v2ray.ng.AppConfig.BUILTIN_OUTBOUND_TAGS
import com.v2ray.ng.dto.ConfigResult
import com.v2ray.ng.dto.ProfileItem
import com.v2ray.ng.dto.RulesetItem
import com.v2ray.ng.dto.V2rayConfig
import com.v2ray.ng.dto.V2rayConfig.OutboundBean
import com.v2ray.ng.dto.V2rayConfig.OutboundBean.OutSettingsBean
import com.v2ray.ng.dto.V2rayConfig.OutboundBean.StreamSettingsBean
import com.v2ray.ng.dto.V2rayConfig.RoutingBean.RulesBean
import com.v2ray.ng.enums.EConfigType
import com.v2ray.ng.enums.NetworkType
import com.v2ray.ng.extension.isNotNullEmpty
import com.v2ray.ng.extension.nullIfBlank
import com.v2ray.ng.fmt.HttpFmt
import com.v2ray.ng.fmt.Hysteria2Fmt
import com.v2ray.ng.fmt.ShadowsocksFmt
import com.v2ray.ng.fmt.SocksFmt
import com.v2ray.ng.fmt.TrojanFmt
import com.v2ray.ng.fmt.VlessFmt
import com.v2ray.ng.fmt.VmessFmt
import com.v2ray.ng.fmt.WireguardFmt
import com.v2ray.ng.util.HttpUtil
import com.v2ray.ng.util.JsonUtil
import com.v2ray.ng.util.LogUtil
import com.v2ray.ng.util.PackageUidResolver
...
object V2rayConfigManager {
    ...
    private fun getV2rayNormalConfig(context: Context, guid: String, config: ProfileItem): ConfigResult {
        ...
        val effectiveRoutingRulesets = SettingsManager.getEffectiveRoutingRulesets(context)
        ...
        getRouting(context, effectiveRoutingRulesets, v2rayConfig)

        getFakeDns(v2rayConfig)

        getDns(effectiveRoutingRulesets, v2rayConfig)

        if (MmkvManager.decodeSettingsBool(AppConfig.PREF_LOCAL_DNS_ENABLED) == true) {
            getCustomLocalDns(effectiveRoutingRulesets, v2rayConfig)
        }
     ...
     * @param v2rayConfig The V2ray configuration object to be modified
     */
    private fun injectCustomOutbounds(v2rayConfig: V2rayConfig, rulesetItems: List<RulesetItem>) {
     ...
     */
    private fun getRouting(context: Context, rulesetItems: List<RulesetItem>, v2rayConfig: V2rayConfig): Boolean {
        try {
            ...
            injectCustomOutbounds(v2rayConfig, rulesetItems)
     ...
     */
    private fun getUserRule2Domain(rulesetItems: List<RulesetItem>, tag: String): ArrayList<String> {
     ...
     */
    private fun getCustomLocalDns(rulesetItems: List<RulesetItem>, v2rayConfig: V2rayConfig): Boolean {
        try {
            if (MmkvManager.decodeSettingsBool(AppConfig.PREF_FAKE_DNS_ENABLED) == true) {
                val geositeCn = arrayListOf(AppConfig.GEOSITE_CN)
                val proxyDomain = getUserRule2Domain(rulesetItems, AppConfig.TAG_PROXY)
                val directDomain = getUserRule2Domain(rulesetItems, AppConfig.TAG_DIRECT)
     ...
     */
    private fun getDns(rulesetItems: List<RulesetItem>, v2rayConfig: V2rayConfig): Boolean {
        try {
            ...
            //block dns
            val blkDomain = getUserRule2Domain(rulesetItems, AppConfig.TAG_BLOCKED)
